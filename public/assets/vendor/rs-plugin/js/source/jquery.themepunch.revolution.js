    ...
    var runSlider = function (container, opt) {
        ...
        if (opt.simplifyAll == "on" && (_R.isIE(8) || _R.iOSVersion())) {
            ...
            opt.allli.each(function () {
                ...
                var img = li.find('.rev-slidebg') || li.find('>images').first();
        ...
        if (!container.hasClass("revslider-initialised")) {
			...
			*/
            ...
            waitForCurrentImages(container.find('.tp-static-layers'), opt, function () {
                container.find('.tp-static-layers images').each(function () {
                    var e = jQuery(this),
...
///////////////////////////////////////
    var prepareSlides = function (container, opt) {
        ...
        opt.allli.find('>images').each(function (j) {
...
// LOAD THE IMAGES OF THE PREDEFINED CONTAINER
    var loadImages = function (container, opt, prio, staticlayer) {
        ...
        container.find('images,.defaultimg, .tp-svg-layer').each(function () {
...
// WAIT PROGRESS TILL THE PREDEFINED CONTAINER HAS ALL IMAGES LOADED INSIDE
    var waitForCurrentImages = function (nextli, opt, callback) {
        ...
        // PRELOAD ALL IMAGES
        nextli.find('images,.defaultimg, .tp-svg-layer').each(function () {
            var element = jQuery(this),
