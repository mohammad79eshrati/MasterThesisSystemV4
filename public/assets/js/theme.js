        ...
        events: function () {
            ...
            if (self.options.imgFluid && self.options.wrapper.is('img')) {
                self.options.wrapper.on('appear', function () {
                    setTimeout(function () {
                        self.options.wrapper.addClass('images-fluid');
                    }, 500);
                });
            }
            ...
            $(window).on('section.scroll.change.header.color', function () {
                ...
                if (self.options.changeHeaderLogo && headerColor != undefined) {
                    if (headerColor == 'light') {
                        $('#header .header-logo images').attr('src', self.options.headerLogoLight);
                    } else if (headerColor == 'dark') {
                        $('#header .header-logo images').attr('src', self.options.headerLogoDark);
                    }
                }
