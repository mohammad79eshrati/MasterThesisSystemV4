<x-container xmlns:x-slot="http://www.w3.org/1999/xlink">
    <x-slot name="title">دفاع های یک رشته</x-slot>
        ...
        <div class="container">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control input-group" placeholder="جستجو ..."
                                       id="search-defenses" value="{{$_GET['q'] ?? ''}}">
            ...
            <div class="row">
                <div class="col p-static mt-1 mb-n1">
                    <h1 data-title-border>دسته بندی دفاع ها</h1>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-1 text-uppercase" data-toggle="collapse"
                                       href="#collapse-{{$d->id}}" data-target="#collapse-{{$d->id}}">
                                        {{$d->name}} ({{getDepratmentDefenses($d)->count()}})
                                    </a>
                                </li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var value = $("#search-defenses").val().toLowerCase();
