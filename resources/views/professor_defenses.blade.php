<x-container xmlns:x-slot="http://www.w3.org/1999/xlink">
    <x-slot name="title">دفاع های یک استاد</x-slot>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col p-static mt-1 mb-n1">
                    <h1 data-title-border><small>استاد : </small> {{$professor->user->name()}}</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col">
                    <div class="blog-posts recent-posts">
                        ...
                        <div id="portfolioLoadMoreWrapper" class="row masonry" data-plugin-masonry
                            ...
                            @foreach($professor->defenses as $d)
                                        ...
                                        <div class="post-content bg-color-grey-scale-2 p-4">
                                            ...
                                            <div class="post-meta m-0 p-0">
                                                <span><i class="far fa-user"></i> دانشجو <a
                                                        href="#"
                                                        class="defense-student">{{$d->student->user->first_name." ".$d->student->user->last_name}}</a></span>
                                                <span class="mb-2"><i class="far fa-user"></i> استاد راهنما <a
                                                        href="#"
                                                        class="defense-professor">{{$d->professor->user->first_name." ".$d->professor->user->last_name}}</a> </span>
